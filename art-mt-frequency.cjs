module.exports = {
  slug: 'maintenance-sharpening-frequency',
  ...
  tags: ['re-grinding frequency', 're-grind interval', 're-grind cost', 'blade economics', 'preventive maintenance'],
  body: `The right re-grinding frequency balances knife life, scrap rate, and re-grind cost. Re-grind too often and you waste stock (each re-grind removes 0.05–0.10 mm); re-grind too late and you produce scrap.

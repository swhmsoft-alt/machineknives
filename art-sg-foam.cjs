module.exports = {
  slug: 'selection-guide-foam-rubber-cutting',
  ...
  tags: ['foam cutting', 'rubber cutting', 'EPDM', 'silicone rubber', 'polyurethane foam', 'slitter blade'],
  body: `Foam and rubber substrates are gummy, abrasive and chemically variable. PU foam, PE foam, EPDM rubber, silicone rubber, natural rubber — each behaves differently at the cut. The wrong blade grade galls immediately. The wrong edge geometry produces a torn surface. The wrong cooling makes the problem worse.

module.exports = {
  slug: 'troubleshooting-thermal-damage',
  ...
  tags: ['thermal damage', 'blueing', 'edge overheating', 'tissue slitter', 'high-speed cutting', 'cooling'],
  body: `A slitter knife that turns blue, straw or purple is being annealed in service. The edge temperature has exceeded the tempering temperature of the steel. The fix is usually cooling first, then grade upgrade, then coating.

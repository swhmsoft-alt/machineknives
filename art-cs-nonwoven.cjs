module.exports = {
  slug: 'case-study-textile-nonwoven-slitter',
  category: 'case-studies',
  title: 'Case Study: Non-Woven Textile Slitter Blade Upgrade for Hygiene Application',
  excerpt: 'A European non-woven producer slitting 25 gsm spunbond at 600 m/min was getting 4 days from a D2 slitter. The fix was a M2 HSS slitter with TiCN coating. 18 days. The case study walks through the audit, the trial, and the role of abrasive fillers in non-woven wear.',
  tags: ['case study', 'non-woven', 'spunbond', 'textile slitter', 'M2 HSS', 'TiCN coating', 'hygiene'],
  body: `In mid-2025 our European distributor called about a non-woven producer slitting 25 gsm spunbond polypropylene for hygiene applications (baby diaper top sheet, femcare coverstock). The customer was getting 4 days from a D2 slitter, with progressive wear on the leading edge. The line was a 1,200 mm-wide slitter running 600 m/min, 24/6, throughput 1,500 kg/day. The non-woven had a calcium carbonate (CaCO₃) filler at 2–3 % by weight, which made it more abrasive than neat PP. Blade consumption was the largest consumable cost on the line. This case study walks through the audit, the trial, and the result.
...
1. **The CaCO₃ filler was the dominant abrasive.** 2–3 % CaCO₃ in PP accelerates D2 wear by 1.5–2× compared to neat PP.
2. **The 5 µm hone was correct for non-woven.** The substrate is soft enough that a sharp hone does not chip.
3. **The chamfer was slightly large.** 0.08 mm chamfer is fine, but 0.05 mm would reduce cutting force and burr growth.
4. **The D2 surface was slightly soft.** 5-point file test: HRC 58 at the surface, HRC 60 at 0.5 mm. Decarburisation from open-air heat treatment.
...
1. **CaCO₃ filler is the dominant abrasive in CaCO₃-filled non-woven.** A 2 % filler adds 50 % wear over neat PP. Specify the filler in the substrate spec.
2. **TiCN beats TiN for non-woven.** TiN is 2,300 HV; TiCN is 2,800 HV. The 25 % hardness gain is the difference between 12 days and 18 days.
3. **The chamfer and hone matter as much as the grade.** A 0.08 mm chamfer is conservative; 0.05 mm is the right answer for soft non-woven.
4. **The line was already efficient.** The savings came from service life extension, not from a fundamental process change.
5. **Audit on site is critical.** The CaCO₃ content was not in the substrate spec; the audit uncovered it.

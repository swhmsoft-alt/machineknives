module.exports = {
  slug: 'selection-guide-crusher-blade',
...
|---|---|---|---|---|
| Jaw crusher | 0.5–1.5 m | 50–300 mm | 100–300 mm | Mn-steel, 12–14 % Mn |
| Hammer mill | 0.1–0.5 m | 5–50 mm | 20–50 mm | D2, DC53, carbide |
| Granulator rotor | 0.1–1.0 m | 5–30 mm | 15–30 mm | D2, M2 HSS, YG8, YG15 |
| Rotary shear | 0.5–2.0 m | 50–200 mm | 50–100 mm | H13, carbide |
| Impact crusher | 0.05–0.3 m | 1–10 mm | 20–60 mm | High-chrome white iron |
...
- **Clearance angle:** 5–12° on the back face.
...
A crusher blade is not sharpened like a slitter. The "edge" is a chamfer; "re-grind" restores the chamfer. Re-grind on specialised carbide grinder (diamond wheels, 0.005–0.010 mm infeed).
...
- "When it looks dull" = 2.5-edge blade, not 4-edge.
...
For broader impact-loaded blade selection, see [How to choose a granulator knife](/selection-guide-granulator-knife/) and [The KAIPU 5-Factor Blade Selection Framework](/kaipu-5-factor-blade-selection-framework/).

For a written crusher blade specification, send the crusher type, substrate, throughput, current blade spec and current service life to [engineering@kaipu-industrial.com](mailto:engineering@kaipu-industrial.com) or use the [request-a-quote form](/contact). Specification, FOB quote and lead time within one business day.
